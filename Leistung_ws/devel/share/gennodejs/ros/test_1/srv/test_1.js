...
class test_1Request {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type test_1Request
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type test_1Request
    let len;
    let data = new test_1Request(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new test_1Request(null);
...
class test_1Response {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type test_1Response
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type test_1Response
    let len;
    let data = new test_1Response(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new test_1Response(null);
...
module.exports = {
  Request: test_1Request,
  Response: test_1Response,
  md5sum() { return '53244230a18aeabb17bd81ddb3a8f9e8'; },
  datatype() { return 'test_1/test_1'; }
};
