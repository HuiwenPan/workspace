...
let simple_moveGoal = require('./simple_moveGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class simple_moveActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = simple_moveGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new simple_moveActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = simple_moveGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new simple_moveGoal()
    }
...
module.exports = simple_moveActionGoal;
